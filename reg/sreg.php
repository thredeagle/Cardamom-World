            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        <h2 class="form-title">Seller SignUp</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Company Name"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="oname" id="oname" placeholder="Owner Name"/>
                        </div>
                        <div class="form-group">
                    ...
                    <p class="loginhere">
                        Signup as a <a href="sreg.php" class="loginhere-link">Customer ?</a><br> 

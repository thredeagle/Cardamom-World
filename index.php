...
<head>
    ...
    <title>Cardamom World | Home </title>
    <!--/google-fonts -->
...
<body>
    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <img src="img/logo.png" height="50" width="50" >&nbsp;   <span class="w3yellow">Cardamom</span> World
                    </a></h1>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <ul class="header-search me-lg-4">
                        <li class="nav-item search-right">
                            <a href="login/login.php" class="btn search-btn btn-primary" title="search"><span class="#" aria-hidden="true">&nbsp;</span>Login</a>
                        </li>
                    </ul>
                    <ul class="header-search me-lg-4">
                    <li class="nav-item search-right">
                            <a href="registration/reg.php" class="btn search-btn btn-primary" title="search"><span class="#" aria-hidden="true">&nbsp;</span>SignUp</a>
                        </li>
                    </ul>   
                    <!--//search-right-->
                </div>
                    ...
                    <div class="container">
                        <div class="w3banner-grids">
                            <div class="banner-info header-hero-19">
                                ...
                                <h3 class="title-hero-19">Unleash the Flavor with Spices.</h3>
        ...
        <div class="container py-md-5 py-3">
            <div class="row w3home-ab-grids">
                <div class="w3ab-right-top col-lg-6 pe-lg-5">
                    <img src="assets/images/crd.jpg" alt="" class="img-fluid radius-image">
                </div>
                <div class="w3ab-left-top col-lg-6 mt-lg-0 mt-4 pt-lg-0 pt-2">
                    <h6 class="title-subw3hny mb-1">Spice up Your Life!</h6>
                    <h3 class="title-w3l mb-2">Welcome to Cardamom World.</h3>
                    <p class="my-3"><ul> We supports <b>Cardamom farmers </b> and <b>Cardamom products sellers</b>.<br> Only <b> Authorized </b> sellers and <b>Certified</b> products. </p>
        ...
        <div class="container py-md-5 py-3">
                <div class="row w3l-passion-mid-grids">
                    ...
                    <div class="col-lg-6 passion-grid-item-info pe-lg-5 mb-lg-0 mb-5">
                        <h6 class="title-subw3hny mb-1">Our Uniqueness</h6>
                        <h3 class="title-w3l mb-4">Single Platform for purchasing products related to Cardamom Farming.  </h3>
                        <p class="mt-3 pe-lg-5">Our platform Provides facilities for pre-booking of fertilizers,pesticides and machineries for Cardamom Farmers.</p>
                        <div class="w3banner-content-btns">
                            <a href="#about" class="btn btn-style btn-primary mt-lg-5 mt-4 me-2">Read More </a>
                    ...
                    <div class="col-lg-6 passion-grid-item-info ps-lg-4">
                        <div class="w3lgrids-1 box-wrap">
                            ...
                            <div class="icon-text">
                                <h4><a href="#service" class="title-head">
                                        Easy Booking</a></h4>
                                <p class="text-para mt-2">Farmers can easily pre-book products in their required quantity and rate.</p>
                            </div>
                        </div>
                        <div class="w3lgrids-1 box-wrap mt-4">
                            ...
                            <div class="icon-text">
                                <h4><a href="#service" class="title-head">Single Platform</a></h4>
                                <p class="text-para mt-2">Single platform for cardamom related product purchasing.</p>
                            </div>
                        </div>
                        <div class="w3lgrids-1 box-wrap mt-4">
                            <div class="icon">
                            ...
                            <div class="icon-text">
                                <h4><a href="#service" class="title-head">Transportation facility</a></h4>
                                <p class="text-para mt-2">Transportation facility for products are provided for Customers.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row gal-page-grids text-center">
                ...
                <div class="col-lg-4 col-6 w3layouts_gallery_grid">
                     <a href="#gal">
                        <div class="w3layouts_team_grid">
                            <img src="assets/images/cult.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_team_grid_pos">
                                <div class="wthree_text">
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-6 w3layouts_gallery_grid">
                     <a href="#gal">
                        <div class="w3layouts_team_grid">
                            <img src="assets/images/c3.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_team_grid_pos">
                                <div class="wthree_text">
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-6 w3layouts_gallery_grid">
                      <a href="#gal">
                        <div class="w3layouts_team_grid">
                            <img src="assets/images/crops.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_team_grid_pos">
                                <div class="wthree_text">
                                </div>
                            </div>
    ...
    <section class="w3l-blog">
        <div class="blog py-5" id="Newsblog">
            <div class="container py-lg-5 py-md-4 py-2">
                <div class="title-content text-center mb-lg-3 mb-4">
                    <h6 class="title-subw3hny mb-1">Sales</h6>
                    <h3 class="title-w3l mb-5">Our Top Sales</h3>
                </div>
                                ...
                                <div class="author align-items-center">
                                    ...
                                    <ul class="blog-meta d-flex mb-2">
                                        <li>
                                            ...
                                            </a> <span class="meta-value"></span><a href="#author"> Customers </a>
                                        </li>
                                        <li>
                                            <a href="#author" class="post-author">
                                            <i class="fas fa-calendar-alt"></i>
                                            </a> <a href="#author">No.Sales</a>
                                        </li>
                                    </ul>

                                </div>
                                <a href="#blog" class="blog-desc">Top selling -<br>pesticide details.</a>
                    ...
                    <div class="col-lg-4 col-md-6 item mt-md-0 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body blog-details">
                                ...
                                <a href="#blog" class="blog-desc">Top selling -<br>Fertilizer details. </a>
                                <p>Lorem ipsum viverra feugiat. Pellen tesque libero ut justo.</p>
                    ...
                    <div class="col-lg-4 col-md-6 item mt-lg-0 mt-5">
                        <div class="card">
                            ...
                            <div class="card-body blog-details">
                                ...
                                <a href="#blog" class="blog-desc">Top selling -<br>Machinery details.</a>
                                <p>Lorem ipsum viverra feugiat. Pellen tesque libero ut justo.</p>
            ...
            <div class="uphny-w3l-newsletter-inf">
                <div class="row uphny-w3l-newsletter align-items-center">
                    <div class="col-lg-6 w3l-newsletter-left text-left">
                        <h3 class="titlehny">Don't miss our future updates! Keep in touch with Us!</h3>
                    </div>
                    <div class="col-lg-6 w3l-newsletter-form ps-lg-5 mt-lg-0 mt-md-5 mt-4">
                        <form action="#" method="post" class="subscribe-wthree">
                            <div class="flex-wrap subscribe-wthree-field">
                                <button class="btn btn-style btn-primary" type="submit">Contact Us</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="w3l-footer-16 py-5">
            <div class="container py-md-5 py-3 pb-0">
                <div class="row footer-p right-side">
                    <div class="col-lg-4 col-md-6 pe-lg-5">
                        <h2 class="footerw3l-logo"><a class="navbar-brand" href="index.html">
                                <span class="w3yellow">Cardamom</span> World
                            </a></h2>
                        <p class="mt-3">The only platform for purchasing Cardamom Pesticides,Fertilizers and Machineries in a single platform.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 column">
                                ...
                                <ul class="footer-gd-16">
                                    ...
                                    <li><a href="#care">
                                            Single Platform</a></li>
                                    <li><a href="#meal">Authorized Sellers</a></li>
                                    <li><a href="#clean">
                                            Fast Booking</a></li>
                                    <li><a href="#medicine">
                ...
                <div class="below-section text-center pt-lg-4 mt-5">
                    <p class="copy-text">&copy; 2023 Cardamom World. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
